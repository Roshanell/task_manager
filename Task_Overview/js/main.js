...
const mainTaskManager = new TaskManager();
mainTaskManager.load();

mainTaskManager.render();
...
form.addEventListener('submit', (event)=>{
  ...
  let duedate = document.getElementById('duedate');
   ...
   if(taskName.value !== '' && assignee.value !== '' && duedate.value !== '' && description.value !== ''){
      mainTaskManager.addTask(taskName.value, description.value, assignee.value, duedate.value);
...
taskList.addEventListener('click', (event)=>{
    if(event.target.classList.contains('done-button')){
      ...
      const task = mainTaskManager.getTaskById(taskId);
      task.status = 'DONE';
      mainTaskManager.render();
      mainTaskManager.save();
    }
